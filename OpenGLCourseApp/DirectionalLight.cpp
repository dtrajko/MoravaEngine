	...
	: Light()
{
	...
	lightProj = glm::ortho(-20.0f, 20.0f, -20.0f, 20.0f, 0.1f, 60.0f);
}
...
{
	return lightProj * glm::lookAt(-m_Direction, glm::vec3(0.0f, -m_Direction.y * 0.5f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
}
