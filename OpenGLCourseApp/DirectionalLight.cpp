	...
	: Light()
{
	...
	lightProj = glm::ortho(-16.0f, 16.0f, -16.0f, 16.0f, 0.1f, 32.0f);
}
...
{
	return lightProj * glm::lookAt(-m_Direction, glm::vec3(0.0f, -m_Direction.y * 0.75f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
}
