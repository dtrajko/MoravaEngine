...
{
	LightManager::directionalLight = DirectionalLight(sceneSettings.shadowMapWidth, sceneSettings.shadowMapHeight, sceneSettings.dirLightColor,
	...
	if (sceneSettings.enablePointLights)
	{
		LightManager::pointLights[0] = PointLight(1024, 1024, 0.01f, 100.0f,
			sceneSettings.pLight_0_color, sceneSettings.pLight_0_ambientIntensity, sceneSettings.pLight_0_diffuseIntensity,
		...
		LightManager::pointLights[1] = PointLight(1024, 1024, 0.01f, 100.0f,
			sceneSettings.pLight_1_color, sceneSettings.pLight_1_ambientIntensity, sceneSettings.pLight_1_diffuseIntensity,
			sceneSettings.pLight_1_position, 0.3f, 0.2f, 0.1f);
		LightManager::pointLightCount++;

		LightManager::pointLights[2] = PointLight(1024, 1024, 0.01f, 100.0f,
			sceneSettings.pLight_2_color, sceneSettings.pLight_2_ambientIntensity, sceneSettings.pLight_2_diffuseIntensity,
			sceneSettings.pLight_2_position, 0.3f, 0.2f, 0.1f);
		LightManager::pointLightCount++;

		LightManager::pointLights[3] = PointLight(1024, 1024, 0.01f, 100.0f,
			sceneSettings.pLight_3_color, sceneSettings.pLight_3_ambientIntensity, sceneSettings.pLight_3_diffuseIntensity,
	...
	if (sceneSettings.enableSpotLights)
	{
		LightManager::spotLights[0] = SpotLight(1024, 1024, 0.01f, 100.0f, 
			...
			0.4f, 0.3f, 0.2f, sceneSettings.sLight_0_edge);
		...
		LightManager::spotLights[1] = SpotLight(1024, 1024, 0.01f, 100.0f,
			...
			0.4f, 0.3f, 0.2f, sceneSettings.sLight_1_edge);
		LightManager::spotLightCount++;
		...
		LightManager::spotLights[2] = SpotLight(1024, 1024, 0.01f, 100.0f,
			...
			0.4f, 0.3f, 0.2f, sceneSettings.sLight_2_edge);
		LightManager::spotLightCount++;
		...
		LightManager::spotLights[3] = SpotLight(1024, 1024, 0.01f, 100.0f,
			...
			0.4f, 0.3f, 0.2f, sceneSettings.sLight_3_edge);
		LightManager::spotLightCount++;
	}
}
