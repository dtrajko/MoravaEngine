#include "EditorLayerHazelVulkan.h"
...
SelectionModeHazelVulkan EditorLayerHazelVulkan::s_SelectionMode = SelectionModeHazelVulkan::Entity;
Hazel::Ref<Hazel::HazelTexture2D> EditorLayerHazelVulkan::s_CheckerboardTexture;
Hazel::Ref<EnvMapMaterial> EditorLayerHazelVulkan::s_DefaultMaterial;
Hazel::Ref<EnvMapMaterial> EditorLayerHazelVulkan::s_LightMaterial;


EditorLayerHazelVulkan::EditorLayerHazelVulkan(const std::string& filepath, Scene* scene)
{
    ...
    m_SceneHierarchyPanel->SetSelectionChangedCallback(std::bind(&EditorLayerHazelVulkan::SelectEntity, this, std::placeholders::_1));
    m_SceneHierarchyPanel->SetEntityDeletedCallback(std::bind(&EditorLayerHazelVulkan::OnEntityDeleted, this, std::placeholders::_1));
...
void EditorLayerHazelVulkan::Init()
{
    Application::Get()->GetWindow()->SetEventCallback(HZ_BIND_EVENT_FN(EditorLayerHazelVulkan::OnEvent));
...
EditorLayerHazelVulkan::~EditorLayerHazelVulkan()
{
...
void EditorLayerHazelVulkan::SetupContextData(Scene* scene)
{
...
void EditorLayerHazelVulkan::SetupRenderFramebuffer()
{
...
Hazel::Entity EditorLayerHazelVulkan::CreateEntity(const std::string& name)
{
    // Both NoECS and ECS
...
Hazel::Entity EditorLayerHazelVulkan::LoadEntity(std::string fullPath)
{
    ...
    Log::GetLogger()->debug("EditorLayerHazelVulkan::LoadMesh: fullPath '{0}' fileName '{1}' fileNameNoExt '{2}'", fullPath, fileName, fileNameNoExt);
...
Hazel::CameraComponent EditorLayerHazelVulkan::GetMainCameraComponent()
{
...
void EditorLayerHazelVulkan::AddSubmeshToSelectionContext(SelectedSubmesh submesh)
{
...
void EditorLayerHazelVulkan::ShowBoundingBoxes(bool showBoundingBoxes, bool showBoundingBoxesOnTop)
{
}

void EditorLayerHazelVulkan::SetupShaders()
{
    Hazel::Ref<Shader> shaderHazelPBR_Static = Shader::Create("Shaders/Hazel/HazelPBR_Static.vs", "Shaders/Hazel/HazelPBR.fs");
    Log::GetLogger()->info("EditorLayerHazelVulkan: m_ShaderHazelPBR_Static compiled [programID={0}]", shaderHazelPBR_Static->GetProgramID());

    Hazel::Ref<Shader> shaderHazelPBR_Anim = Shader::Create("Shaders/Hazel/HazelPBR_Anim.vs", "Shaders/Hazel/HazelPBR.fs");
    Log::GetLogger()->info("EditorLayerHazelVulkan: m_ShaderHazelPBR_Anim compiled [programID={0}]", shaderHazelPBR_Anim->GetProgramID());

    Hazel::Ref<Shader> shaderRenderer2D_Line = Shader::Create("Shaders/Hazel/Renderer2D_Line.vs", "Shaders/Hazel/Renderer2D_Line.fs");
    Log::GetLogger()->info("EditorLayerHazelVulkan: m_ShaderRenderer2D_Line compiled [programID={0}]", shaderRenderer2D_Line->GetProgramID());

    EnvMapSharedData::s_ShaderOutline = Shader::Create("Shaders/Hazel/Outline.vs", "Shaders/Hazel/Outline.fs");
    Log::GetLogger()->info("EditorLayerHazelVulkan: shaderOutline compiled [programID={0}]", EnvMapSharedData::s_ShaderOutline->GetProgramID());

    m_ShaderShadow = Shader::Create("Shaders/directional_shadow_map.vert", "Shaders/directional_shadow_map.frag");
    Log::GetLogger()->info("EditorLayerHazelVulkan: m_ShaderShadow compiled [programID={0}]", m_ShaderShadow->GetProgramID());

    m_ShaderOmniShadow = Shader::Create("Shaders/omni_shadow_map.vert", "Shaders/omni_shadow_map.geom", "Shaders/omni_shadow_map.frag");
    Log::GetLogger()->info("EditorLayerHazelVulkan: m_ShaderOmniShadow compiled [programID={0}]", m_ShaderOmniShadow->GetProgramID());

    m_ShaderPostProcessing = Shader::Create("Shaders/env_map_post_processing.vert", "Shaders/env_map_post_processing.frag");
    Log::GetLogger()->info("EditorLayerHazelVulkan: m_ShaderPostProcessing compiled [programID={0}]", m_ShaderPostProcessing->GetProgramID());
    ...
    Log::GetLogger()->info("EditorLayerHazelVulkan: m_ShaderBloomBlur compiled [programID={0}]", m_ShaderBloomBlur->GetProgramID());
...
void EditorLayerHazelVulkan::UpdateUniforms()
{
...
void EditorLayerHazelVulkan::SetSkybox(Hazel::Ref<Hazel::HazelTextureCube> skybox)
{
    m_SkyboxTexture = skybox;
    m_SkyboxTexture->Bind(EnvMapSharedData::s_SamplerSlots.at("u_Texture"));
}

void EditorLayerHazelVulkan::OnUpdate(float timestep)
{
    switch (m_SceneState)
    {
...
void EditorLayerHazelVulkan::OnUpdateEditor(Hazel::Ref<Hazel::HazelScene> scene, float timestep)
{
...
void EditorLayerHazelVulkan::OnUpdateRuntime(Hazel::Ref<Hazel::HazelScene> scene, float timestep)
{
    EnvMapSharedData::s_EditorScene = scene;
...
void EditorLayerHazelVulkan::OnScenePlay()
{
...
void EditorLayerHazelVulkan::OnSceneStop()
{
...
void EditorLayerHazelVulkan::UpdateWindowTitle(const std::string& sceneName)
{
 ...
 **/
void EditorLayerHazelVulkan::CameraSyncECS()
{
...
void EditorLayerHazelVulkan::UpdateImGuizmo(Window* mainWindow)
{
    // BEGIN ImGuizmo
    ...
    if (Scene::s_ImGuizmoType != -1 && EntitySelection::s_SelectionContext.size())
    {
        ...
        if (s_SelectionMode == SelectionModeHazelVulkan::Entity || !selectedSubmesh.Mesh)
        {
            ImGuizmo::Manipulate(
        ...
        else if (s_SelectionMode == SelectionModeHazelVulkan::SubMesh)
        {
...
Ref<Hazel::Entity> EditorLayerHazelVulkan::GetMeshEntity()
{
...
float& EditorLayerHazelVulkan::GetSkyboxLOD()
{
    return EnvMapSharedData::s_EditorScene->GetSkyboxLod();
}

void EditorLayerHazelVulkan::SetViewportBounds(glm::vec2* viewportBounds)
{
    m_ViewportBounds[0] = viewportBounds[0];
    m_ViewportBounds[1] = viewportBounds[1];
}

void EditorLayerHazelVulkan::SetSkyboxLOD(float LOD)
{
    EnvMapSharedData::s_EditorScene->SetSkyboxLod(LOD);
}

Hazel::Ref<Shader> EditorLayerHazelVulkan::GetShaderPBR_Anim()
{
    return ShaderLibrary::Get("HazelPBR_Anim");
}

Hazel::Ref<Shader> EditorLayerHazelVulkan::GetShaderPBR_Static()
{
    return ShaderLibrary::Get("HazelPBR_Static");
}

void EditorLayerHazelVulkan::DrawIndexed(uint32_t count, Hazel::PrimitiveType type, bool depthTest)
{
    if (!depthTest)
...
void EditorLayerHazelVulkan::OnImGuiRender(Window* mainWindow, Scene* scene)
{
    bool p_open = true;
    ...
    ImGui::Begin("Viewport");
    {
        ...
        // Calculate Viewport bounds (used in EditorLayerHazelVulkan::CastRay)
    ...
    ImGui::Begin("Viewport Environment Map");
    {
        ...
        // ResizeViewport(viewportPanelSizeEnvMap, m_EditorLayerHazelVulkan->GetSceneRenderer()->s_Data.CompositePass->GetSpecification().TargetFramebuffer);
        Hazel::Ref<Framebuffer> targetFramebuffer = EnvMapSceneRenderer::GetCompositePass()->GetSpecification().TargetFramebuffer;
    ...
    ImGui::Begin("Selection");
    {
        ...
        ImGui::SameLine();
        const char* label = s_SelectionMode == SelectionModeHazelVulkan::Entity ? "Entity" : "Mesh";
        if (ImGui::Button(label))
        {
            s_SelectionMode = s_SelectionMode == SelectionModeHazelVulkan::Entity ? SelectionModeHazelVulkan::SubMesh : SelectionModeHazelVulkan::Entity;
        }
...
void EditorLayerHazelVulkan::ShowExampleAppDockSpace(bool* p_open, Window* mainWindow)
{
...
void EditorLayerHazelVulkan::NewScene()
{
    OnNewScene(m_ViewportMainSize);
}
 
void EditorLayerHazelVulkan::OpenScene()
{
...
void EditorLayerHazelVulkan::SaveScene()
{
...
void EditorLayerHazelVulkan::SaveSceneAs()
{
    auto app = Application::Get();
...
void EditorLayerHazelVulkan::OnNewScene(glm::vec2 viewportSize)
{
...
void EditorLayerHazelVulkan::SelectEntity(Hazel::Entity e)
{
}

void EditorLayerHazelVulkan::SubmitMesh(Hazel::HazelMesh* mesh, const glm::mat4& transform, Material* overrideMaterial)
{
...
void EditorLayerHazelVulkan::ResizeViewport(glm::vec2 viewportPanelSize, Hazel::Ref<Framebuffer> renderFramebuffer)
{
...
void EditorLayerHazelVulkan::OnEvent(Event& e)
{
    if (m_SceneState == SceneState::Edit)
    {
    ...
    dispatcher.Dispatch<KeyPressedEvent>(HZ_BIND_EVENT_FN(EditorLayerHazelVulkan::OnKeyPressedEvent));
    dispatcher.Dispatch<MouseButtonPressedEvent>(HZ_BIND_EVENT_FN(EditorLayerHazelVulkan::OnMouseButtonPressed));
}

bool EditorLayerHazelVulkan::OnKeyPressedEvent(KeyPressedEvent& e)
{
    if (m_ViewportPanelFocused)
    {
        switch (e.GetKeyCode())
...
bool EditorLayerHazelVulkan::OnMouseButtonPressed(MouseButtonPressedEvent& e)
{
...
void EditorLayerHazelVulkan::OnSelected(const SelectedSubmesh& selectionContext)
{
...
void EditorLayerHazelVulkan::OnEntityDeleted(Hazel::Entity e)
{
    if (EntitySelection::s_SelectionContext.size())
    {
...
std::pair<float, float> EditorLayerHazelVulkan::GetMouseViewportSpace()
{
...
std::pair<glm::vec3, glm::vec3> EditorLayerHazelVulkan::CastRay(float mx, float my)
{
    ...
    Log::GetLogger()->debug("EditorLayerHazelVulkan::CastRay | MousePosition [ {0} {1} ]", mx, my);
    Log::GetLogger()->debug("EditorLayerHazelVulkan::CastRay | m_ViewportBounds[0] [ {0} {1} ]", m_ViewportBounds[0].x, m_ViewportBounds[0].y);
    Log::GetLogger()->debug("EditorLayerHazelVulkan::CastRay | m_ViewportBounds[1] [ {0} {1} ]", m_ViewportBounds[1].x, m_ViewportBounds[1].y);
    Log::GetLogger()->debug("EditorLayerHazelVulkan::CastRay | mouseClipPos [ {0} {1} ]", mouseClipPos.x, mouseClipPos.y);

    return { rayPos, rayDir };
}

std::vector<glm::mat4> EditorLayerHazelVulkan::CalculateLightTransform(glm::mat4 lightProj, glm::vec3 position)
{
...
void EditorLayerHazelVulkan::OnRenderShadow(Window* mainWindow)
{
...
void EditorLayerHazelVulkan::OnRenderShadowOmni(Window* mainWindow)
{
...
void EditorLayerHazelVulkan::RenderShadowOmniSingleLight(Window* mainWindow, Hazel::Entity lightEntity, Hazel::Ref<OmniShadowMap> omniShadowMap)
{
...
void EditorLayerHazelVulkan::RenderSubmeshesShadowPass(Hazel::Ref<Shader> shader)
{
...
void EditorLayerHazelVulkan::OnRender(Window* mainWindow)
{
...
void EditorLayerHazelVulkan::PostProcessing(Window* mainWindow)
{
...
void EditorLayerHazelVulkan::OnRenderEditor()
{
    EnvMapSceneRenderer::GeometryPass();
    EnvMapSceneRenderer::CompositePass();
}

void EditorLayerHazelVulkan::OnRenderRuntime()
{
    EnvMapSceneRenderer::GeometryPass();
    EnvMapSceneRenderer::CompositePass();
}
