...
void VulkanTestLayer::OnUpdateMorava(Hazel::Timestep ts, Hazel::HazelCamera* camera) // const Hazel::EditorCamera& camera
{
	m_Camera.OnUpdate(ts);

	glm::vec4 clearColor = { 0.1f, 0.1f, 0.1f, 1.0f };
	RenderMorava(clearColor, camera);
}
...
void VulkanTestLayer::RenderMorava(const glm::vec4& clearColor, Hazel::HazelCamera* camera)
{
	// Hazel::HazelRenderer::Submit([=]() mutable
	// {
	// });
