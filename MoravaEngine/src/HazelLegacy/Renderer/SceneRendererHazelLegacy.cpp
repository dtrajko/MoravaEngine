...
namespace Hazel
{
	...
	SceneRendererHazelLegacy::SceneRendererHazelLegacy(Ref<HazelScene> scene, SceneRendererSpecificationVulkan specification)
	...
	void SceneRendererHazelLegacy::SetScene(Ref<HazelScene> scene)
	{
	}
	...
	void SceneRendererHazelLegacy::BeginScene(SceneHazelLegacy* scene, const SceneRendererCameraVulkan& camera)
	{
	...
	void SceneRendererHazelLegacy::SubmitMesh(Ref<HazelMesh> mesh, const glm::mat4& transform, Ref<HazelMaterial> overrideMaterial)
	{
		// TODO: Culling, sorting, etc.
		s_Data.DrawList.push_back({ mesh, overrideMaterial, transform });
	}

	void SceneRendererHazelLegacy::SubmitSelectedMesh(Ref<HazelMesh> mesh, const glm::mat4& transform)
	{
	...
	SceneRendererOptionsVulkan& SceneRendererHazelLegacy::GetOptions()
	{
