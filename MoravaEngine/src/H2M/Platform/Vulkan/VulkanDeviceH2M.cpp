...
namespace H2M
{
	...
	VkFormat VulkanPhysicalDeviceH2M::FindDepthFormat() const
	{
	...
	bool VulkanPhysicalDeviceH2M::IsExtensionSupported(const std::string& extensionName) const
	{
		return m_SupportedExtensions.find(extensionName) != m_SupportedExtensions.end();
	}

	VulkanPhysicalDeviceH2M::QueueFamilyIndicesH2M VulkanPhysicalDeviceH2M::GetQueueFamilyIndices(int flags)
	{
		QueueFamilyIndicesH2M indices;
	...
	uint32_t VulkanPhysicalDeviceH2M::GetMemoryTypeIndex(uint32_t typeBits, VkMemoryPropertyFlags properties) const
	{
	...
	RefH2M<VulkanPhysicalDeviceH2M> VulkanPhysicalDeviceH2M::Select()
	{
		return RefH2M<VulkanPhysicalDeviceH2M>::Create();
	}
	...
	VulkanDeviceH2M::VulkanDeviceH2M(const RefH2M<VulkanPhysicalDeviceH2M>& physicalDevice, VkPhysicalDeviceFeatures enabledFeatures)
	...
	VulkanDeviceH2M::~VulkanDeviceH2M()
	{
	}
	...
	void VulkanDeviceH2M::FlushCommandBuffer(VkCommandBuffer commandBuffer)
	{
		FlushCommandBuffer(commandBuffer, m_Queue);
	}

	void VulkanDeviceH2M::FlushCommandBuffer(VkCommandBuffer commandBuffer, VkQueue queue)
	{
	...
	VkCommandBuffer VulkanDeviceH2M::CreateSecondaryCommandBuffer()
	{
		VkCommandBuffer cmdBuffer;
	...
	/**
	 * Buffer Helper Functions (VulkanGameEngine by Brendan Galea) 
	 */
	void VulkanDeviceH2M::CreateBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
	{
	 ...
	 * Buffer Helper Functions (VulkanGameEngine by Brendan Galea)
	 */
	VkCommandBuffer VulkanDeviceH2M::BeginSingleTimeCommands()
	{
	 ...
	 * Buffer Helper Functions (VulkanGameEngine by Brendan Galea)
	 */
	void VulkanDeviceH2M::EndSingleTimeCommands(VkCommandBuffer commandBuffer)
	{
	 ...
	 * Buffer Helper Functions (VulkanGameEngine by Brendan Galea)
	 */
	void VulkanDeviceH2M::CopyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
	{
	 ...
	 * Buffer Helper Functions (VulkanGameEngine by Brendan Galea)
	 */
	void VulkanDeviceH2M::CopyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height, uint32_t layerCount)
	{
		VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
	 ...
	 * Buffer Helper Functions (VulkanGameEngine by Brendan Galea)
	 */
	void VulkanDeviceH2M::CreateImageWithInfo(const VkImageCreateInfo& imageInfo, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
	{
	 ...
	 * Buffer Helper Functions (VulkanGameEngine by Brendan Galea)
	 */
	uint32_t VulkanDeviceH2M::FindMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
	{
		VkPhysicalDeviceMemoryProperties memProperties;
		vkGetPhysicalDeviceMemoryProperties(m_PhysicalDevice->GetVulkanPhysicalDevice(), &memProperties);
