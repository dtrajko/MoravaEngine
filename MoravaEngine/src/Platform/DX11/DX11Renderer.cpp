...
void DX11Renderer::BeginRenderPass(Hazel::Ref<Hazel::RenderCommandBuffer> renderCommandBuffer, const Hazel::Ref<Hazel::RenderPass>& renderPass, bool explicitClear)
{
	// Hazel::HazelRenderer::Submit([]() {});
