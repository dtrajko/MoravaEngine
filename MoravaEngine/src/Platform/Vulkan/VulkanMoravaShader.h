...
public:
	...
	static Hazel::Ref<VulkanMoravaShader> Create(const char* vertexLocation, const char* fragmentLocation, bool forceCompile = false);
	static Hazel::Ref<VulkanMoravaShader> Create(const char* vertexLocation, const char* geometryLocation, const char* fragmentLocation, bool forceCompile = false);
	static Hazel::Ref<VulkanMoravaShader> Create(const char* computeLocation, bool forceCompile = false);
...
private:
	...
	static std::vector<Hazel::Ref<VulkanMoravaShader>> s_AllShaders;
