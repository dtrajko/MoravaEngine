...
class VulkanMoravaFramebuffer : public MoravaFramebuffer
{
public:
	VulkanMoravaFramebuffer();
	VulkanMoravaFramebuffer(unsigned int width, unsigned int height);
	VulkanMoravaFramebuffer(FramebufferSpecification spec);
	~VulkanMoravaFramebuffer();
