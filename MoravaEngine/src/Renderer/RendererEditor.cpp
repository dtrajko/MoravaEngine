...
{
    H2M::RefH2M<OpenGLMoravaShader> shaderEditor = MoravaShader::Create("Shaders/editor_object.vs", "Shaders/editor_object.fs");
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderEditorPBR = MoravaShader::Create("Shaders/editor_object.vs", "Shaders/PBR/editor_object_pbr.fs");
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderSkinning = MoravaShader::Create("Shaders/OGLdev/skinning.vs", "Shaders/OGLdev/skinning.fs");
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderHybridAnimPBR = MoravaShader::Create("Shaders/HybridAnimPBR.vs", "Shaders/HybridAnimPBR.fs");
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderShadowMap = MoravaShader::Create("Shaders/directional_shadow_map.vert", "Shaders/directional_shadow_map.frag");
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderOmniShadowMap = MoravaShader::Create("Shaders/omni_shadow_map.vert", "Shaders/omni_shadow_map.geom", "Shaders/omni_shadow_map.frag");
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderWater = MoravaShader::Create("Shaders/water.vert", "Shaders/water.frag");
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderBackground = MoravaShader::Create("Shaders/LearnOpenGL/2.2.2.background.vs", "Shaders/LearnOpenGL/2.2.2.background.fs");
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderBasic = MoravaShader::Create("Shaders/basic.vs", "Shaders/basic.fs");
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderGizmo = MoravaShader::Create("Shaders/gizmo.vs", "Shaders/gizmo.fs");
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderGlass = MoravaShader::Create("Shaders/glass.vs", "Shaders/glass.fs");
...
void RendererEditor::RenderPassShadow(Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderShadowMap = RendererBasic::GetShaders()["shadow_map"];
...
void RendererEditor::RenderPassOmniShadow(PointLight* light, Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    ...
    H2M::RefH2M<MoravaShader> shaderOmniShadow = RendererBasic::GetShaders()["omni_shadow_map"];
...
void RendererEditor::RenderPassWaterReflection(Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderEditor = RendererBasic::GetShaders()["editor_object"];
    shaderEditor->Bind();
    ...
    H2M::RefH2M<MoravaShader> shaderEditorPBR = RendererBasic::GetShaders()["editor_object_pbr"];
    shaderEditorPBR->Bind();
    ...
    H2M::RefH2M<MoravaShader> shaderSkinning = RendererBasic::GetShaders()["skinning"];
    shaderSkinning->Bind();
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderHybridAnimPBR = RendererBasic::GetShaders()["hybrid_anim_pbr"];
    shaderHybridAnimPBR->Bind();
...
void RendererEditor::RenderPassWaterRefraction(Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderEditorPBR = RendererBasic::GetShaders()["editor_object_pbr"];
    shaderEditorPBR->Bind();
    shaderEditorPBR->SetMat4("view", scene->GetCamera()->GetViewMatrix());
    shaderEditorPBR->SetMat4("projection", projectionMatrix);
    shaderEditorPBR->SetFloat3("eyePosition", scene->GetCamera()->GetPosition());
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderSkinning = RendererBasic::GetShaders()["skinning"];
    shaderSkinning->Bind();
    shaderSkinning->SetMat4("view", scene->GetCamera()->GetViewMatrix());
    shaderSkinning->SetMat4("projection", projectionMatrix);
...
void RendererEditor::RenderPassMain(Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    ...
    H2M::RefH2M<MoravaFramebuffer> renderFramebuffer;
...
void RendererEditor::RenderStageSetUniforms(Scene* scene, glm::mat4* projectionMatrix)
{
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderOmniShadowMap = RendererBasic::GetShaders()["omni_shadow_map"];
    ...
    /**** Begin shaderWater ****/
    H2M::RefH2M<OpenGLMoravaShader> shaderWater = RendererBasic::GetShaders()["water"];
    shaderWater->Bind();
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderBackground = RendererBasic::GetShaders()["background"];
    ...
    H2M::RefH2M<OpenGLMoravaShader> shaderBasic = RendererBasic::GetShaders()["basic"];
    shaderBasic->Bind();
    ...
    /**** Begin gizmo shader ****/
    H2M::RefH2M<OpenGLMoravaShader> shaderGizmo = RendererBasic::GetShaders()["gizmo"];
    shaderGizmo->Bind();
    ...
    /**** Begin glass ****/
    H2M::RefH2M<OpenGLMoravaShader> shaderGlass = RendererBasic::GetShaders()["glass"];
    shaderGlass->Bind();
