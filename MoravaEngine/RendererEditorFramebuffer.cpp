...
RendererEditorFramebuffer::RendererEditorFramebuffer()
{
}

void RendererEditorFramebuffer::Init(Scene* scene)
{
	SetUniforms();
	SetShaders();
}

void RendererEditorFramebuffer::SetUniforms()
{
}
...
void RendererEditorFramebuffer::RenderPassShadow(Window& mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
...
void RendererEditorFramebuffer::RenderPassOmniShadow(PointLight* light, Window& mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
...
void RendererEditorFramebuffer::RenderPassWaterReflection(Window& mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
...
void RendererEditorFramebuffer::RenderPassWaterRefraction(Window& mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    if (!scene->GetSettings().enableWaterEffects) return;
...
void RendererEditorFramebuffer::RenderOmniShadows(Window& mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    if (!scene->GetSettings().enableOmniShadows) return;
...
void RendererEditorFramebuffer::RenderWaterEffects(float deltaTime, Window& mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    if (!scene->GetSettings().enableWaterEffects) return;
...
void RendererEditorFramebuffer::RenderPass(Window& mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    SceneEditorFramebuffer* sceneEditorFramebuffer = (SceneEditorFramebuffer*)scene;

    Framebuffer* renderFramebuffer = sceneEditorFramebuffer->GetRenderFramebuffer();
