...
{
	// Standard PBR inputs
	m_Params.Albedo    = u_MaterialUniforms.AlbedoTexToggle > 0.5    ? texture(u_AlbedoTexture, vs_Input.TexCoord).rgb : u_MaterialUniforms.AlbedoColor; 
	m_Params.Metalness = u_MaterialUniforms.MetalnessTexToggle > 0.5 ? texture(u_MetalnessTexture, vs_Input.TexCoord).r : u_MaterialUniforms.Metalness;
	m_Params.Roughness = u_MaterialUniforms.RoughnessTexToggle > 0.5 ?  texture(u_RoughnessTexture, vs_Input.TexCoord).r : u_MaterialUniforms.Roughness;
