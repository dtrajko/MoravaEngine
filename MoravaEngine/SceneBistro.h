...
const int MAX_LIGHTS_BISTRO = 4 + 4; // (4 x point lights) + (4 x spot lights)
...
private:
	...
	Hazel::MeshAnimPBR* m_MeshAnimPBR_BistroExterior;

	Material* m_BaseMaterial_BistroExterior;
