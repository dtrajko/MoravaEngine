...
SceneEditorFramebuffer::SceneEditorFramebuffer()
{
...
void SceneEditorFramebuffer::SetLightManager()
{
...
void SceneEditorFramebuffer::SetupRenderFramebuffer()
{
    ...
    // m_RenderFramebuffer->CreateTextureAttachmentColor(width, height, AttachmentFormat::Color);
    // m_RenderFramebuffer->CreateAttachmentDepth(width, height, AttachmentType::Renderbuffer, AttachmentFormat::Depth);
}

void SceneEditorFramebuffer::SetSkybox()
{
}

void SceneEditorFramebuffer::SetupTextures()
{
...
void SceneEditorFramebuffer::SetupMaterials()
{
...
void SceneEditorFramebuffer::SetupMeshes()
{
    m_Quad = new Quad();
}

void SceneEditorFramebuffer::SetupModels()
{
...
void SceneEditorFramebuffer::SetGeometry()
{
}

void SceneEditorFramebuffer::SelectNextFromMultipleObjects(std::vector<SceneObject*>* sceneObjects, unsigned int& selectedIndex)
{
    // Cooldown
...
bool SceneEditorFramebuffer::IsObjectSelected(unsigned int objectIndex)
{
    return objectIndex = m_SelectedIndex;
}

void SceneEditorFramebuffer::SaveScene()
{
    // Cooldown
    if (m_CurrentTimestamp - m_SceneSave.lastTime < m_SceneSave.cooldown) return;
    m_SceneSave.lastTime = m_CurrentTimestamp;

    printf("SceneEditorFramebuffer::SaveScene: Saving %zu objects...\n", m_SceneObjects.size());
    ...
    printf("SceneEditorFramebuffer::SaveScene: Content saved to file '%s'\n", m_SceneFilename);
}

void SceneEditorFramebuffer::LoadScene()
{
    // Cooldown
    if (m_CurrentTimestamp - m_SceneLoad.lastTime < m_SceneLoad.cooldown) return;
    m_SceneLoad.lastTime = m_CurrentTimestamp;

    printf("SceneEditorFramebuffer::LoadScene: Loading objects...\n");
...
void SceneEditorFramebuffer::UpdateImGui(float timestep, Window& mainWindow)
{
    bool p_open = true;
...
void SceneEditorFramebuffer::ResizeViewport(glm::vec2 viewportPanelSize)
{
    // Cooldown
    ...
    if (viewportPanelSize != m_ViewportSize && viewportPanelSize.x > 0 && viewportPanelSize.y > 0)
    {
        ...
        m_CameraController->OnResize(viewportPanelSize.x, viewportPanelSize.y); // TODO
    }
...
void SceneEditorFramebuffer::ShowExampleAppDockSpace(bool* p_open, Window & mainWindow)
{
...
void SceneEditorFramebuffer::Update(float timestep, Window& mainWindow)
{
    ...
    // printf("SceneEditorFramebuffer::Update m_SceneObjects.size = %zu\n", m_SceneObjects.size());
...
void SceneEditorFramebuffer::UpdateLightDirection(glm::quat rotation)
{
...
Mesh* SceneEditorFramebuffer::CreateNewMesh(int meshTypeID, glm::vec3 scale, std::string* name)
{
    Mesh* mesh;
    switch (meshTypeID)
    {
...
SceneObject* SceneEditorFramebuffer::CreateNewSceneObject()
{
...
void SceneEditorFramebuffer::AddSceneObject()
{
    // Cooldown
...
void SceneEditorFramebuffer::CopySceneObject(Window& mainWindow, std::vector<SceneObject*>* sceneObjects, unsigned int& selectedIndex)
{
    // Cooldown
...
void SceneEditorFramebuffer::DeleteSceneObject(Window& mainWindow, std::vector<SceneObject*>* sceneObjects, unsigned int& selectedIndex)
{
    // Cooldown
...
Model* SceneEditorFramebuffer::AddNewModel(int modelID, glm::vec3 scale)
{
    Model* model;
    switch (modelID)
    {
...
SceneObjectParticleSystem* SceneEditorFramebuffer::AddNewSceneObjectParticleSystem(int objectTypeID, glm::vec3 scale)
{
...
void SceneEditorFramebuffer::SetUniformsShaderEditor(Shader* shaderEditor, Texture* texture, SceneObject* sceneObject)
{
    shaderEditor->Bind();
...
void SceneEditorFramebuffer::SetUniformsShaderEditorPBR(Shader* shaderEditorPBR, Texture* texture, Material* material, SceneObject* sceneObject)
{
...
void SceneEditorFramebuffer::SetUniformsShaderSkinning(Shader* shaderSkinning, SceneObject* sceneObject, float runningTime)
{
...
void SceneEditorFramebuffer::SetUniformsShaderWater(Shader* shaderWater, SceneObject* sceneObject, glm::mat4& projectionMatrix)
{
...
void SceneEditorFramebuffer::SwitchOrthographicView(Window& mainWindow, glm::mat4& projectionMatrix)
{
...
glm::mat4 SceneEditorFramebuffer::CalculateRenderTransform(SceneObject* sceneObject)
{
...
bool SceneEditorFramebuffer::IsWaterOnScene()
{
    for (auto& object : m_SceneObjects) {
...
void SceneEditorFramebuffer::AddLightsToSceneObjects()
{
    printf("SceneEditorFramebuffer::AddLightsToSceneObjects()\n");
    ...
    printf("SceneEditorFramebuffer::AddLightsToSceneObjects Add Directional Light m_SceneObjects[%i]\n", (int)m_SceneObjects.size() - 1);
    ...
    for (unsigned int i = 0; i < LightManager::pointLightCount; i++)
    {
        ...
        printf("SceneEditorFramebuffer::AddLightsToSceneObjects Add Point Light m_SceneObjects[%i]\n", (int)m_SceneObjects.size() - 1);
    }
    ...
    for (unsigned int i = 0; i < LightManager::spotLightCount; i++)
    {
        ...
        printf("SceneEditorFramebuffer::AddLightsToSceneObjects Add Spot Light m_SceneObjects[%i]\n", (int)m_SceneObjects.size() - 1);
    }
}

void SceneEditorFramebuffer::RenderLightSources(Shader* shaderGizmo)
{
    shaderGizmo->Bind();
...
void SceneEditorFramebuffer::RenderSkybox(Shader* shaderBackground)
{
...
void SceneEditorFramebuffer::RenderLineElements(Shader* shaderBasic, glm::mat4 projectionMatrix)
{
...
void SceneEditorFramebuffer::RenderFramebufferTextures(Shader* shaderEditor)
{
...
void SceneEditorFramebuffer::RenderGlassObjects(Shader* shaderGlass)
{
...
void SceneEditorFramebuffer::CleanupGeometry()
{
}
